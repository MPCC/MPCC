...
BEGIN
	CREATE TABLE dbo.[Notification] (
		...
		ActionText nvarchar(128) NULL,
		ActionApiMethod nvarchar(10) NULL,
		ActionApi nvarchar(255) NULL,
		ActionOccurred bit NOT NULL CONSTRAINT DF_Notification_ActionOccurred DEFAULT((0)),
